...
> [!TIP]
> To deploy this project using **GUI-based flow**, navigate to [console](https://console.stacktape.com/create-new-project/git-project-using-console?name=my-stacktape-app&repositoryType=public&repositoryUrl=https://github.com/stacktape/starter-gatsbyjs-website)

- statically-built [Gatsby.js](https://gatsbyjs.com/) application.
...
```bash
stacktape init --starterId gatsbyjs-website
```
